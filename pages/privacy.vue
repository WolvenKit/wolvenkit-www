<template class="margin-left">
  <div class="flex justify-center items-center">
    <div class="ml-10 mb-32 mt-10 w-[80rem]">
      <div class="revert-tailwind white font">
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to RedModding.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to RedModding, accessible from
              <a
                href="https://redmodding.org"
                rel="external nofollow noopener"
                target="_blank"
                >https://redmodding.org</a
              >
            </p>
          </li>
          <li>
