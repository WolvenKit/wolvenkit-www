export default {
  ...
  index: {
    ...
    tools: {
      ...
      cybercatDescription: 'Outil d\'assistant de personnalisation Cyberpunk 2077. Éditeur de sauvegarde (en cours de développement).'
    }
  },
  blog: {
    pageTitle: 'Blog',
    pageDescription: 'Progrès, nouveaux développements et mises à jour des fonctionnalités',
    published: 'Publié le'
  },
  projects: {
    pageTitle: 'Projets',
    pageDescription: 'Tous les projets de l\'équipe et de la communauté',
    teamProjects: 'Projets de l\'équipe',
    communityProjects: 'Projets de la communauté',
    contribute: 'Contribuer',
    contributors: 'Contributeurs'
  },
  team: {
    pageTitle: 'Équipe',
    pageDescription: 'Présentation de notre vaste équipe qui rend tout possible',
    teamDescription: 'Notre équipe est composée de personnes du monde entier, réunies par une passion pour la programmation et une volonté d\'améliorer l\'expérience de jeu.',
    projectFilter: {
